 ...
 */
extern struct cw_key *(*cw_key_get)(const char *key, int type);
 ...
 *
 */
extern int (*cw_check_signature)(struct cw_key *key, const char *msg, const char *sig);
 ...
 *
 */
extern int (*cw_check_signature_bin)(struct cw_key *key, const char *msg, int msglen, const unsigned char *sig);
 ...
 *
 */
extern int (*cw_sign)(struct cw_key *key, char *msg, char *sig);
 ...
 *
 */
extern int (*cw_sign_bin)(struct cw_key *key, const char *msg, int msglen, unsigned char *sig);
 ...
 *
 */
extern int (*cw_encrypt_bin)(unsigned char *dst, const unsigned char *src, int srclen, struct cw_key *key);
 ...
 *
 */
extern int (*cw_decrypt_bin)(unsigned char *dst, const unsigned char *src, int srclen, struct cw_key *key);
#if defined(__cplusplus) || defined(c_plusplus)
}
#endif
