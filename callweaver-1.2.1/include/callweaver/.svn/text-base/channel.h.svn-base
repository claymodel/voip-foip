...
/* Spy stuff */
void cw_queue_spy_frame(struct cw_channel_spy *spy, struct cw_frame *f, int q);
void cw_spy_empty_queues(struct cw_channel_spy *spy, struct cw_frame **f0,
                         struct cw_frame **f1);
void cw_spy_get_frames(struct cw_channel_spy *spy, struct cw_frame **f0,
                       struct cw_frame **f1);
